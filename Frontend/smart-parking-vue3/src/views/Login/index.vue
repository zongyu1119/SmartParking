  ...
  <div class="login-wrap">
    <el-form class="login-container"
      ...
      <el-form-item label="验证码">
        ...
        <el-col :span="11">
          <el-image style="width: 90px; height: 35px"
                    :src="CaptchUrl"
                    fit="contain"
                    @click="getCaptchData()" />
        </el-col>
...
export default {
  ...
  mounted () {
    getCaptch().then(res => {
      this.CaptchId = res.captchId
      this.CaptchUrl = 'data:image/png;base64,' + res.captchBase64Str
    })
  },
  methods: {
    dosubmit: function () {
      ...
      login(params).then(res => {
        ...
        if (!res)
          ...
          let bearer = res.token;
          localStorage.setItem("token", bearer);
          this.$router.push('/Home');
        }
      })
    },
    getCaptchData: function () {
      getCaptch().then(res => {
        this.CaptchId = res.captchId
        this.CaptchUrl = 'data:image/png;base64,' + res.captchBase64Str
      })
